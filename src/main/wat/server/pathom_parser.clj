(ns wat.server.pathom-parser
  (:require [com.wsscode.pathom.connect :as pc]
            [com.wsscode.pathom.core :as p]
            [wat.models.project :refer [project-resolvers]]
            [wat.models.document :refer [document-resolvers]]
            [wat.models.session :as session]
            [wat.models.user :as user]
            [wat.models.common :refer [server-error]]
            [wat.server.config :refer [config]]
            [wat.server.xtdb :refer [xtdb-node]]
