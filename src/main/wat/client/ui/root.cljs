(ns wat.client.ui.root
  (:require
    ...
    [wat.client.ui.drawer :refer [ui-drawer Drawer]]
    [wat.client.ui.common.core :refer [loader]]
    [wat.client.ui.project.core :refer [ProjectRouter]]
    [wat.client.ui.document.core :refer [DocumentRouter]]
    [wat.client.ui.user-settings.core :refer [UserSettings]]
    [wat.client.ui.admin.core :refer [AdminRouter]]
    [wat.client.ui.home :refer [Home]]
    [wat.client.ui.login :refer [logout-button Login]]
    [wat.client.ui.global-snackbar :refer [ui-global-snackbar GlobalSnackbar]]
    ...
    (mui/theme-provider {:theme mui/default-theme}
      ...
      (mui/app-bar {:position "static"}
        (mui/toolbar {:variant "dense"}
          ...
          ((mui/styled-typography {:flex-grow 1}) {:variant "h5"} "WAT")
